    ...
    <div class="full-height">
        ...
        <main class="content--container">
            ...
            <div class="entry-a panel show" data-panel="entry-a">
                ...
                <audio src="audio/feb/february-phantomvoices-sonicmeditation.mp3"></audio>
            </div>
            ...
            <div class="entry-c panel hide" data-panel="entry-c">
                ...
                Monthly supper, along with other WTFPC activities, can be tracked <a href="https://foodpoeticsclub.werkplaatstypografie.org/">here.</p>
                <audio src="audio/feb/february-phantomvoices-silentlunch.mp3"></audio>
            </div>
            ...
            <div class="entry-e panel show" data-panel="entry-e">
                ...
                <audio src="audio/feb/february-phantomvoices-intermezzo.mp3"></audio>
            </div>
        </div>
            ...
            <div class="content--right">
                <ul class="audio-menu">
                    <li>
                        <a class="entry-a js-show-panel" data-panel="entry-a">The “fig.” of Woman as the White Noise of History</a>
                    </li>
                    <li><a class="entry-b js-show-panel" data-panel="entry-b">Sonic Meditation “Ear Ly / Sex Change” </a></li>[<!-- Audio: february-phantomvoices-sonicmeditation.mp3] -->
                    <li><a class="entry-c js-show-panel" data-panel="entry-c">Food Poetics Club”</a></li>[<!-- Audio: later -->
                    <li><a class="entry-d js-show-panel" data-panel="entry-d">“Reflections on her Voice” visual score by Hannah Sakai”</a></li>[<!-- Audio: later -->
                    <li><a class="entry-e js-show-panel" data-panel="entry-e">Intermezzo</a></li>[<!-- Audio: february-phantomvoices-intermezzo.mp3]-->
