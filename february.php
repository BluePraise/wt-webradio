    ...
    <div class="full-height">
        ...
        <main class="content--container">
            ...
            <div class="content--right">
                <ul class="audio-menu">
                    <li>
                        <a class="entry-a">The “fig.” of Woman as the White Noise of History</a>
                    </li>
                    <li><a class="entry-b">Sonic Meditation “Ear Ly / Sex Change” </a></li>[<!-- Audio: february-phantomvoices-sonicmeditation.mp3] -->
                    <li><a class="entry-c">Food Poetics Club”</a></li>[<!-- Audio: later -->
                    <li><a class="entry-d">“Reflections on her Voice” visual score by Hannah Sakai”</a></li>[<!-- Audio: later -->
