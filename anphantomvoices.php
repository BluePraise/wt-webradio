...
<div class="full-height">
    ...
    <main class="content--container__basic">
        <div class="content--txt content--left">
            ...
            <p>Voices from the Air<span class="footnote">(3)</span>[footnote]</p>
            ...
            <div class="flex-table">
                <div class="col">
                    ...
                    <div class="cell">Your voices</div>
            ...
            <p>This Listening That I Give as Well as Through Which I Take<span class="footnote">(4)</span>[footnote]</p>
            ...
            <p>Like the frame of a stereoscope, a subwoofer enclosure presents a perceived singularity from an inherent plurality. Ironic though, how the word “audio,” as Micah Silver puts it, can be best understood as plural: “It is neither one thing or a category of a thing.”<span class="footnote">(5)</span>[footnote] To listen then, is to parse, to find the inherent multiplicities of this thing we call audio. An active listener, listens not to necessarily record, but to instead find the recording already embedded in what’s being heard.<span class="footnote">(6)</span>[footnote]</p>
        ...
        <div class="content--txt content--left">
            ...
            <p>The WT Food Poetics Club supplies the “An Phantom Voices” weeks with exercises during shared meals, such as Straw Phonation and Collective Gargle, followed by a Silent Lunch, as well as Incorporation Rituals hosted by invited guests. WT Food Poetics Club is initiated by Gerardo Madera. Activities can be tracked <a class="content-link" href="#">here</a>.</p>
