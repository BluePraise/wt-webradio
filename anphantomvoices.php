...
<div class="full-height">
    ...
    <main class="content--container__basic">
        <div class="content--txt content--left">
            ...
            <p>Voices from the Air(3)[footnote]</p>
            ...
            <p>This Listening That I Give as Well as Through Which I Take(4)[footnote]</p>
            ...
            <p>Like the frame of a stereoscope, a subwoofer enclosure presents a perceived singularity from an inherent plurality. Ironic though, how the word “audio,” as Micah Silver puts it, can be best understood as plural: “It is neither one thing or a category of a thing.”(5)[footnote] To listen then, is to parse, to find the inherent multiplicities of this thing we call audio. An active listener, listens not to necessarily record, but to instead find the recording already embedded in what’s being heard.(6)[footnote]</p>
